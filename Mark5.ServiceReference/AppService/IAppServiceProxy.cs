...
namespace Mark5.ServiceReference.AppService
{
    public interface IAppServiceProxy
    {
        ...
        Task<GetCalendarAppointmentOccurrencesResult> GetCalendarAppointmentOccurrencesAsync(GetCalendarAppointmentOccurrencesParameters parameters, CancellationToken ct = default(CancellationToken));
        ...
        Task<DeleteCalendarAppointmentResult> DeleteCalendarAppointmentAsync(DeleteCalendarAppointmentParameters parameters, CancellationToken ct = default(CancellationToken));
