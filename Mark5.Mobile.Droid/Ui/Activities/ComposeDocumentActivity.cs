...
namespace Mark5.Mobile.Droid.Ui.Activities
{
    ...
    public class ComposeDocumentActivity : AppCompatActivity
    {
        ...
        public static Intent CreateIntent(Context context, DocumentCreationModeFlag creationModeFlag, DocumentDirection previousDocumentDirection, int? precedingDocumentId = null, int? precedingDocumentFolderId = null, Guid outgoingDocumentGuid = default(Guid), List<string> preconfiguredEmailToAddresses = null, List<string> preconfiguredEmailCcAddresses = null, List<string> preconfiguredEmailBccAddresses = null)
        {
