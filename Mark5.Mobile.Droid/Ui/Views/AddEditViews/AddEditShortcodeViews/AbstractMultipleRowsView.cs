...
{
    public abstract class AbstractMultipleRowsView<T> : AddEditShortcodeView
    {
        ...
        static public AppCompatImageButton GetButton(Context context, bool addButton = true)
        {
            ...
            button.SetColorFilter(addButton ? new Color(Android.Support.V4.Content.ContextCompat.GetColor(context, Resource.Color.darkblue)) : new Color(ContextCompat.GetColor(context, Resource.Color.brown)));
        ...
        abstract protected class Row
        {
            ...
            protected readonly AddEditShortcodeView ParentView;

            protected T Content;

            protected Row(Context context, AddEditShortcodeView parentView)
            {
