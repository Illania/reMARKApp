...
using Mark5.Mobile.Droid.Ui.Views.AutoReplyViews;
using Mark5.Mobile.Droid.Ui.Views.Common;
using Mark5.Mobile.Droid.Ui.Views.ComposeDocumentViews;
using Mark5.Mobile.Droid.Utilities;
using ContentView = Mark5.Mobile.Droid.Ui.Views.AutoReplyViews.ContentView;
using FormattingView = Mark5.Mobile.Droid.Ui.Views.AutoReplyViews.FormattingView;
using LineView = Mark5.Mobile.Droid.Ui.Views.AutoReplyViews.LineView;
using SubjectView = Mark5.Mobile.Droid.Ui.Views.AutoReplyViews.SubjectView;
