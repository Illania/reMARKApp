...
namespace reMark.Mobile.Common.Storage.AppFileStorage.Interface
{
	/// <summary>
	/// Represents a file
	/// </summary>
	public interface IFile
	{
		...
		Task<Stream> OpenAsync(Enum.FileAccess fileAccess, CancellationToken cancellationToken = default(CancellationToken));
