...
using reMark.Mobile.Common.Storage.AppFileStorage.Utils;

namespace reMark.Mobile.Common.Storage.AppFileStorage
{
    /// <summary>
    ...
    public class AppFileSystemFolder : IFolder
    {
        ...
        public AppFileSystemFolder(string path, bool canDelete)
        {
        ...
        public AppFileSystemFolder(string path)
            : this(path, false)
        {
        }
        ...
        public async Task<IFile> CreateFileAsync(string desiredName, CreationCollisionOption option, CancellationToken cancellationToken)
        {
            ...
            var ret = new AppFileSystemFile(newPath);
            return ret;
        }
        ...
        public async Task<IFile> GetFileAsync(string name, CancellationToken cancellationToken)
        {
            ...
            var ret = new AppFileSystemFile(path);
            return ret;
        }
        ...
        public async Task<IList<IFile>> GetFilesAsync(CancellationToken cancellationToken)
        {
            await AwaitExtensions.SwitchOffMainThreadAsync(cancellationToken);
            EnsureExists();
            IList<IFile> ret = Directory.GetFiles(Path).Select(f => new AppFileSystemFile(f)).ToList<IFile>().AsReadOnly();
            return ret;
        }
        ...
        public async Task<IFolder> CreateFolderAsync(string desiredName, CreationCollisionOption option, CancellationToken cancellationToken)
        {
            ...
            var ret = new AppFileSystemFolder(newPath, true);
            return ret;
        }
        ...
        public async Task<IFolder> GetFolderAsync(string name, CancellationToken cancellationToken)
        {
            ...
            var ret = new AppFileSystemFolder(path, true);
            return ret;
        }
        ...
        public async Task<IList<IFolder>> GetFoldersAsync(CancellationToken cancellationToken)
        {
            await AwaitExtensions.SwitchOffMainThreadAsync(cancellationToken);
            EnsureExists();
            IList<IFolder> ret = Directory.GetDirectories(Path).Select(d => new AppFileSystemFolder(d, true)).ToList<IFolder>().AsReadOnly();
            return ret;
        }
        ...
        public async Task<ExistenceCheckResult> CheckExistsAsync(string name, CancellationToken cancellationToken)
        {
            ...
            await AwaitExtensions.SwitchOffMainThreadAsync(cancellationToken);
            string checkPath = System.IO.Path.Combine(this.Path, name);
