...
using reMark.Mobile.IOS.PushNotifications;
...
namespace reMark.Mobile.IOS
{
    ...
    public class AppDelegate : UIApplicationDelegate, IUNUserNotificationCenterDelegate, IMessagingDelegate
    {
        ...
        public override bool ShouldRestoreSecureApplicationState(UIApplication application, NSCoder coder)
        {
       ...
       [Export("userNotificationCenter:willPresentNotification:withCompletionHandler:")]
        ...
        //  <array>
        //      <string>com.nordic-it.reMark.Mobile.IOS.task</string>
        //  </array>
...
#if !DEBUG
                CommonConfig.Logger.Level = reMark.Mobile.Common.Utilities.LogLevel.INFO;
#else
                CommonConfig.Logger.Level = reMark.Mobile.Common.Utilities.LogLevel.DEBUG;
#endif
