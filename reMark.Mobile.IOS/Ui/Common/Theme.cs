...
namespace reMark.Mobile.IOS.Ui.Common
{
    ...
    public static class Theme
    {
        ...
        public static void ApplyTheme(this UIWindow window)
        {
            ...
            UIBarButtonItem.Appearance.SetTitleTextAttributes(new UIStringAttributes
            {
            ...
            UITabBarItem.Appearance.SetTitleTextAttributes(new UIStringAttributes
            {
                Font = DefaultFont.CustomFont().WithRelativeSize(-5f)
            }, UIControlState.Normal);

            UISegmentedControl.Appearance.TintColor = DarkerBlue;
            UISegmentedControl.Appearance.SetTitleTextAttributes(new UIStringAttributes
            {
            ...
            UISegmentedControl.AppearanceWhenContainedIn(typeof(DarkNavigationController)).SetTitleTextAttributes(new UIStringAttributes
            {
                Font = DefaultFont.CustomFont().WithRelativeSize(-4f),
