    ...
    public class ModuleNavigationController : UIViewController
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            View.AddConstraints(new[]
            {
                ...
                closeButtonContainer.BottomAnchor.ConstraintEqualTo(Integration.IsRunningAtLeast(11) ? View.SafeAreaLayoutGuide.BottomAnchor : BottomLayoutGuide.TopAnchor, 2),
            });
