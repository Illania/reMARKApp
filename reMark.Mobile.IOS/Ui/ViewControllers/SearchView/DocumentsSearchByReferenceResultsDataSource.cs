...
namespace reMark.Mobile.IOS.Ui.ViewControllers.SearchView
{
    ...
    public class DocumentsSearchByReferenceResultsDataSource : UITableViewSource
    {
        public bool Empty => Items.Count < 1;
        public List<DocumentPreview> Items { get; } = new List<DocumentPreview>(1000);

        readonly WeakReference<DocumentsSearchByReferenceResultsViewController> viewControllerWeakReference;
        readonly WeakReference<UITableView> tableViewWeakReference;
        readonly bool compactList;

        bool loading = true;

        public DocumentsSearchByReferenceResultsDataSource(DocumentsSearchByReferenceResultsViewController viewController, UITableView tableView, bool compactList)
        {
