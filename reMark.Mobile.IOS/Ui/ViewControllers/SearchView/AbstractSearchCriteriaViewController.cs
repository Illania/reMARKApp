...
namespace reMark.Mobile.IOS.Ui.ViewControllers.SearchView
{
    public abstract class AbstractSearchCriteriaViewController : AbstractViewController
    {
        ...
        public override void LoadView()
        {
            ...
            closeItem.SetTitleTextAttributes(new UIStringAttributes() { ForegroundColor = UIColor.White }, UIControlState.Normal);
            ...
            resetItem.SetTitleTextAttributes(new UIStringAttributes() { ForegroundColor = UIColor.White }, UIControlState.Normal);
            ...
            if (Integration.IsRunningAtLeast(11))
                ...
                searchButtonBottomConstraint1 = SearchButton.BottomAnchor.ConstraintEqualTo(BottomLayoutGuide.TopAnchor, -8f);
        ...
        private void CreateSaveButton()
        {
            ...
            if (Integration.IsRunningAtLeast(11))
                ...
                saveButtonBottomConstraint1 = SaveButton.BottomAnchor.ConstraintEqualTo(BottomLayoutGuide.TopAnchor, -8f);
