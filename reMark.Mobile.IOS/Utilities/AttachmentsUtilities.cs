...
using reMark.Mobile.IOS.Ui.ViewControllers.MailViewerView;
using QuickLook;
using UIKit;
...
namespace reMark.Mobile.IOS.Utilities
{
    ...
    public class PreviewItem : QLPreviewItem
    {
        ...
        public override NSUrl PreviewItemUrl => fileUrl;
        public override string PreviewItemTitle => fileUrl.LastPathComponent;
