...
namespace Mark5.Mobile.IOS.Ui.ViewControllers
{
    public class CopyToUserWorktrayViewController : AbstractTableViewController, IUISearchResultsUpdating
    {
        ...
        public CopyToUserWorktrayViewController()
        ...
        class DataSource : UITableViewSource
        {
            ...
            readonly WeakReference<CopyToUserWorktrayViewController> viewControllerWeakReference;
            readonly WeakReference<UITableView> tableViewWeakReference;

            bool loading = true;
            readonly List<SystemUser> items = new List<SystemUser>(50);

            public DataSource(CopyToUserWorktrayViewController viewController, UITableView tableView)
            {
        ...
        class SearchDataSource : UITableViewSource
        {
            ...
            public SearchDataSource(CopyToUserWorktrayViewController viewController, UITableView tableView)
            {
                viewControllerWeakReference = viewController.Wrap();
                tableViewWeakReference = tableView.Wrap();
            }
