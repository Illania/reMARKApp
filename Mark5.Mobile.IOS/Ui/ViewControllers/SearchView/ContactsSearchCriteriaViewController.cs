...
namespace Mark5.Mobile.IOS.Ui.ViewControllers.SearchView
{
    ...
    {
        SearchContactsCriteria criteria = new();
        public SavedContactsSearch CurrentSavedSearch { get; set; }
        ContactsSavedSearchesView savedSearchesView = null;
        ...
        public override void LoadView()
        {
            ...
            {
                savedSearchesView = new ContactsSavedSearchesView(this);
        ...
        protected async void HandleSaveButtonChoice(int choice)
        {
            switch (choice)
            {
                case 0:
                    if (CurrentSavedSearch != null)
                        await Managers.SearchManager.UpdateSavedContactsSearchAsync(CurrentSavedSearch.Id, CurrentSavedSearch);
                    break;
                case 1:
                    await AddNewSavedSearch();
                    break;
        ...
        public void UpdateCurrentSavedSearch(SavedContactsSearch savedSearch)
        {
        ...
        private async Task AddNewSavedSearch()
        {
            try
            {
                ...
                var newSavedSearch = new SavedContactsSearch() { Criteria = CurrentSavedSearch?.Criteria ?? criteria, Name = newName };
        ...
        class ContactsSavedSearchesView : AbstractContactsSearchView
        {
            readonly WeakReference<ContactsSearchCriteriaViewController> parentViewControllerWeakReference;
            ...
            public ContactsSavedSearchesView(ContactsSearchCriteriaViewController parentViewController)
            {
                parentViewControllerWeakReference = parentViewController.Wrap();
            ...
            async void Tapped(UITapGestureRecognizer recognizer)
            {
                var vc = new SavedContactSearchesViewController();
                parentViewControllerWeakReference.Unwrap()?.PresentViewController(new NavigationController(vc, UIModalPresentationStyle.PageSheet), true, null);
