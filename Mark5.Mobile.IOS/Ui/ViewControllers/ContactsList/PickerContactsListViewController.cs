...
namespace Mark5.Mobile.IOS.Ui.ViewControllers.ContactsList
{
    public class PickerContactsListViewController : AbstractContactsListViewController
    {
        ...
        public async override void ContactSelected(UITableView tableView, ContactPreview contactPreview)
        {
            ...
            try
            {
                ...
                {
                    var index = await Dialogs.ShowListDialogAsync(this, string.Empty, emailAddresses, cell);
                    if (index < 0)
                        return;
