...
namespace reMark.Mobile.Droid.Ui.Fragments
{
    public class NotificationsListFragment : BaseFragment
    {
        ...
        {
            menu.AddMenuItem(Menu.None, MenuItemActions.MarkAllAsRead, MenuItemActions.MarkAllAsRead, Resource.String.mark_all_as_read, this);
        }
        ...
        public override bool OnOptionsItemSelected(IMenuItem item)
        {
            ...
            {
                CommonConfig.UsageAnalytics.LogEvent(new NotificationMarkAllAsReadEvent(objectTypes.First().Module()));
                MarkAllAsRead();
                return true;
            }
