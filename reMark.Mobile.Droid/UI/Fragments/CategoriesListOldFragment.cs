...
{
    public class CategoriesListOldFragment : BaseFragment, SearchView.IOnQueryTextListener, IMenuItemOnActionExpandListener, IMenuItemOnMenuItemClickListener
    {
        ...
        public static (CategoriesListOldFragment fragment, string tag) NewInstance(BusinessEntityPreview businessEntity)
        {
            ...
            var fragment = new CategoriesListOldFragment
            {
                Arguments = args
            };

            var tag = $"{nameof(CategoriesListOldFragment)} [businessEntity.id={businessEntity.Id}, businessEntity.objectType={businessEntity.ObjectType}]";
        ...
        {
            CommonConfig.Logger.Info($"Creating {nameof(CategoriesListOldFragment)} [businessEntity.id={BusinessEntityPreview?.Id}, businessEntity.objectType={BusinessEntityPreview?.ObjectType}]");
        ...
        public override void OnViewCreated(View view, Bundle savedInstanceState)
        {
            ...
            CommonConfig.Logger.Info($"Created {nameof(CategoriesListOldFragment)} [businessEntity.id={BusinessEntityPreview?.Id}, businessEntity.objectType={BusinessEntityPreview?.ObjectType}]");
        }

        public override void OnResume()
        {
            base.OnResume();
            CommonConfig.Logger.Info($"Refreshing {nameof(CategoriesListOldFragment)} [businessEntity.id={BusinessEntityPreview?.Id}, businessEntity.objectType={BusinessEntityPreview?.ObjectType}]");
            SetDefaultSections();
            GetData();
        }
