...
using ContentView = reMark.Mobile.Droid.Ui.Views.DocumentViews.ContentView;
...
namespace reMark.Mobile.Droid.Ui.Fragments
{
    public class DocumentFragment : BaseFragment
    {
        ...
        public override void OnCreateOptionsMenu(IMenu menu, MenuInflater inflater)
        {
            ...
            {
                var goToPreviousItem = menu.AddMenuItem(Menu.None, 
                    MenuItemActions.GoToPrevious, MenuItemActions.GoToPrevious, 
                    Resource.String.document_previous, this);
                goToPreviousItem?.SetShowAsAction(ShowAsAction.Always);

                var goToNextItem = menu.AddMenuItem(Menu.None, 
                    MenuItemActions.GoToNext, MenuItemActions.GoToNext, 
                    Resource.String.document_next, this);
                goToNextItem?.SetShowAsAction(ShowAsAction.Always);
            }

            if (!_documentPreview.IsReadByCurrent)
            {
                menu.AddMenuItem(Menu.None, MenuItemActions.MarkAsRead, 
                    MenuItemActions.MarkAsRead, Resource.String.mark_as_read, this);
            }

            if (_documentPreview.IsReadByCurrent)
            {
                menu.AddMenuItem(Menu.None, MenuItemActions.MarkAsUnread, 
                    MenuItemActions.MarkAsUnread, Resource.String.marks_as_unread, this);
            }

            if (ServerConfig.SystemSettings.DocumentsModuleInfo.WorktrayEnabled ?? true)
            {
                menu.AddMenuItem(Menu.None, MenuItemActions.CopyToWorktray, 
                    MenuItemActions.CopyToWorktray, Resource.String.copy_to_worktray, this);
            }

            menu.AddMenuItem(Menu.None, MenuItemActions.CopyToFolder, 
                MenuItemActions.CopyToFolder, Resource.String.copy_to_folder, this);
            ...
            {
                menu.AddMenuItem(Menu.None, MenuItemActions.MoveToFolder, 
                    MenuItemActions.MoveToFolder, Resource.String.move_to_folder, this);
            }

            menu.AddMenuItem(Menu.None, MenuItemActions.SetPriority, 
                MenuItemActions.SetPriority, Resource.String.set_priority, this);
            menu.AddMenuItem(Menu.None, MenuItemActions.Categories, 
                MenuItemActions.Categories, Resource.String.categories, this);

            if (_document != null)
            {
                menu.AddMenuItem(Menu.None, MenuItemActions.Comments, 
                    MenuItemActions.Comments, Resource.String.comments, this);
            }

            menu.AddMenuItem(Menu.None, MenuItemActions.Actions, 
                MenuItemActions.Actions, Resource.String.history, this);
            menu.AddMenuItem(Menu.None, MenuItemActions.Links, 
                MenuItemActions.Links, Resource.String.overview, this);

            menu.AddMenuItem(Menu.None, MenuItemActions.Print, 
                MenuItemActions.Print, Resource.String.print, this);

            if (_folder?.InternalType == FolderInternalType.FilterView ||
                _folder?.InternalType == FolderInternalType.Static ||
                _folder?.InternalType == FolderInternalType.Worktray)
            {
                menu.AddMenuItem(Menu.None, MenuItemActions.DeleteFromFolder, 
                    MenuItemActions.DeleteFromFolder, Resource.String.delete_from_folder, this);
            }
            ...
            {
                menu.AddMenuItem(Menu.None, MenuItemActions.Delete, 
                    MenuItemActions.Delete, Resource.String.delete, this);
            }

            menu.AddMenuItem(Menu.None, MenuItemActions.CopyToNew, 
                MenuItemActions.CopyToNew, Resource.String.copy_to_new, this);

            if (ServerConfig.SystemSettings.SystemInfo.DeliveryReportAvailable)
            {
                menu.AddMenuItem(Menu.None, MenuItemActions.DeliveryReport, 
                    MenuItemActions.DeliveryReport, Resource.String.delivery_report, this);
            }
        }
