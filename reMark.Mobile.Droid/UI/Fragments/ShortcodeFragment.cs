...
using reMark.Mobile.Droid.Ui.Views.ShortcodeViews;
...
namespace reMark.Mobile.Droid.Ui.Fragments
{
    public class ShortcodeFragment : BaseFragment
    {
        ...
        public override void OnCreateOptionsMenu(IMenu menu, MenuInflater inflater)
        {
            ...
            menu.AddMenuItem(Menu.None, MenuItemActions.CreateNewDocument, MenuItemActions.CreateNewDocument, Resource.String.create_new_document, this);
