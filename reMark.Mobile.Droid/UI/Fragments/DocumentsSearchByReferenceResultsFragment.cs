...
{
    public class DocumentsSearchByReferenceResultsFragment : BaseFragment
    {
        const string SearchDocumentsByReferenceCriteriaBundleKey = "SearchDocumentsByReferenceCriteria_273f369b-8818-4944-9dfc-5193a7bd542a";
        const string DocumentPreivewsKey = "DocumentPreviews_88491381-02c2-40ec-a560-d74c788fcf1f";
        ...
        DocumentSearchByReferenceResultsAdapter adapter;

        bool shouldNotifyAdapter;

        public static (DocumentsSearchByReferenceResultsFragment fragment, string var) NewInstance(SearchDocumentsCriteria criteria)
        {
            var args = new Bundle();

            if (criteria != null)
                args.PutString(SearchDocumentsByReferenceCriteriaBundleKey, Serializer.Serialize(criteria));

            var fragment = new DocumentsSearchByReferenceResultsFragment();
            fragment.Arguments = args;

            var tag = $"{nameof(DocumentsSearchByReferenceResultsFragment)}]";
        ...
        public override void OnCreate(Bundle savedInstanceState)
        {
            ...
            if (Arguments.ContainsKey(SearchDocumentsByReferenceCriteriaBundleKey))
                criteria = Serializer.Deserialize<SearchDocumentsCriteria>(Arguments.GetString(SearchDocumentsByReferenceCriteriaBundleKey));
        ...
        {
            CommonConfig.Logger.Info($"Creating {nameof(DocumentsSearchByReferenceResultsFragment)} [criteria={criteria}]...");
            ...
            adapter = new DocumentSearchByReferenceResultsAdapter(Activity, recyclerView);
        ...
        public override void OnViewCreated(View view, Bundle savedInstanceState)
        {
            ...
            CommonConfig.Logger.Info($"Created {nameof(DocumentsSearchByReferenceResultsFragment)} [criteria={criteria}]");
        }
        ...
        public override async void OnResume()
        {
            ...
            CommonConfig.Logger.Info($"Resuming {nameof(DocumentsSearchByReferenceResultsFragment)} [criteria={criteria}]...");
        ...
        public override void OnPause()
        {
            ...
            CommonConfig.Logger.Info($"Pausing {nameof(DocumentsSearchByReferenceResultsFragment)} [criteria={criteria}]...");
        }
        ...
        {
            var data = new Intent();
            data.PutExtra(SearchByReferenceResultsActivity.SearchByReferenceResultKey, Serializer.Serialize(documentPreview.Id));
        ...
        class DocumentSearchByReferenceResultsAdapter : RecyclerView.Adapter, ISectionedAdapter
        { 
            ...
            public DocumentSearchByReferenceResultsAdapter(Context context, RecyclerView recyclerView)
            {
