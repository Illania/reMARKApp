...
using ContentView = reMark.Mobile.Droid.Ui.Views.ComposeDocumentViews.ContentView;
...
#pragma warning restore RECS0165 // Asynchronous methods should return a Task instead of void
        ...
        public override void OnCreateOptionsMenu(IMenu menu, MenuInflater inflater)
        {
            ...
            var insertTemplateItem = menu.AddMenuItem(Menu.None, MenuItemActions.InsertTemplate, MenuItemActions.InsertTemplate, Resource.String.insert_template, this);
            insertTemplateItem.SetIcon(Resource.Drawable.action_add);
            insertTemplateItem.SetShowAsAction(ShowAsAction.Always);

            var attachmentItem = menu.AddMenuItem(Menu.None, MenuItemActions.AddAttachment, MenuItemActions.AddAttachment, Resource.String.add_attachment, this);
        ...
        public override bool OnOptionsItemSelected(IMenuItem item)
        {
            ...
            if (item.ItemId == MenuItemActions.AddAttachment)
            {
                ...
                {
                    if (choice == 0) //reMark external documents
