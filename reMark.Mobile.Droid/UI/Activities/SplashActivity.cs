...
using reMark.Mobile.Droid.Utilities.Workers;
...
{
    [Activity(MainLauncher = true, Icon = "@mipmap/ic_icon", Theme = "@style/reMarkSplash", 
    ...
    public class SplashActivity : AppCompatActivity
    {
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            ((reMarkApplication)ApplicationContext).StartedFromRoot = true;
        ...
        private void HandleSendIntent(Intent intent)
        {
            ...
            {
                ((reMarkApplication)ApplicationContext).StartedFromShareOptions = true;
        ...
        protected override void OnStart()
        {
            ...
            {
                if (((reMarkApplication)ApplicationContext).StartedFromShareOptions == true)
                    return;
