...
namespace reMark.Mobile.Droid.Ui.Activities
{
    ...
    public class LoginActivity : BaseAppCompatActivity
    {
        ...
        {
            menu.AddMenuItem(IMenu.None, MenuItemActions.SystemReport, MenuItemActions.SystemReport, Resource.String.create_system_report,Context);
            return true;
        }
        ...
        async void LoginWithMicrosoftButton_Click(object sender, EventArgs e)
        {
            ...
            {
                await ManageLoginException(ex, new CancellationToken(), true);
            }
            finally
            {
                btn.Clickable = true;
        ...
        async void LoginButton_Click(object sender, EventArgs e)
        {
            ...
            {
                await ManageLoginException(ex, new CancellationToken(), false);
            }
            finally
            {
                btn.Clickable = true;
