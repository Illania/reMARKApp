...
namespace Mark5.Mobile.Common.Manager
{
    public interface IDocumentsManager
    {
        ...
        Task<List<DocumentPreview>> GetDocumentPreviewsAsync(int folderId, Guid folderGuid, int startId = -1, int endId = -1, SourceType sourceType = SourceType.Auto);
        ...
        Task SetDocumentReadStatusAsync(DocumentPreview documentPreview, Document document, bool isRead, SourceType sourceType = SourceType.Auto);
        ...
        Task<string> GetAttachmentAsync(AttachmentDescription attachmentDescription, int documentId, bool checkMD5 = false, SourceType sourceType = SourceType.Auto);
