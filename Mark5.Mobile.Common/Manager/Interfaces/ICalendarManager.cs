...
namespace Mark5.Mobile.Common.Manager
{
    public interface ICalendarManager
    {
        ...
        Task<int> CreateOrUpdateCalendarAppointmentAsync(int calendarId, CalendarAppointment calendarAppointment, AppointmentChangeType appointmentChangeype, SourceType sourceType = SourceType.Auto);
