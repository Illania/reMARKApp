...
namespace Mark5.Mobile.Common.Manager
{
    public interface ICommonActionsManager
    {
        ...
        Task CopyToFolder(List<int> ids, ObjectType objectType, int folderId, SourceType sourceType = SourceType.Auto);
        ...
        Task CopyToWorktray(List<int> ids, ObjectType objectType, SourceType sourceType = SourceType.Auto);
        ...
        Task CopyToUserWorktray(List<int> ids, ObjectType objectType, List<SystemUser> systemUsers, string comment = null, SourceType sourceType = SourceType.Auto);
