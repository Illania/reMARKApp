...
{
    class IndeterminateCircularProgressDrawable : BaseIndeterminateProgressDrawable
    {
        static readonly int ProgressIntrinsicSizeDP = 42;
        static readonly int PaddedIntrinsicSizeDP = 48;
        static readonly RectF RectBound = new RectF(-21, -21, 21, 21);
		static readonly RectF RectPaddedBound = new RectF(-24, -24, 24, 24);
        static readonly RectF RectProgress = new RectF(-19, -19, 19, 19);
            ...
            : base(context)
		{
            ...
            Animators = new Animator[] {
                MaterialProgressBar.Animators.CreateIndeterminate(ringPathTransform),
                MaterialProgressBar.Animators.CreateIndeterminateRotation(ringRotation)
		    };
		}
