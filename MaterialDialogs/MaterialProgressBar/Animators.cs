...
using static MaterialDialogs.MaterialProgressBar.IndeterminateCircularProgressDrawable;
using static MaterialDialogs.MaterialProgressBar.IndeterminateHorizontalProgressDrawable;
